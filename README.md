...
　日勤専用(基本9時〜18時),夜勤専用(基本21時〜6時),２交代制(日勤,夜勤を1週間ごと)として<br>
　修正申請等を入れやすいように平日7％の確率でユーザーごとに出勤なし、休憩一般的な1日3回(残業時4回)、残業30%の確率としてシーダーファイルを作成致しました。)<br><br>
...
# 今後開発品質の高い効率の良いWEB開発をしていく上でのまとめ（模擬案件の時だけ掲載）<br>
   ...
   - もくもく会でお話を聞くことができたのですがpro生の,姫野太雅さん,亀山裕樹さん(Java),一倉さやかさん(Ruby),ozaponさんなどのお話で,Laravel以外の開発も携わっているということを聞き,他の言語(JavaやRubyもしくはPython)などの案件に私も携わることができたらと,JavaScript(Nuxt.js,React等)を学習しながらですが,模擬案件2つ目終了した後に私も未来を見据えて仕事で活躍できるように進めてみようと思っています。
<br>
