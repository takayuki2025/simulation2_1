...
　勤怠記録情報はランダムで生成されます。(週休2日制(土日休み)31日分、平日10％の確率でユーザーごとに出勤なし、休憩一般的な1日３回としてシーダーファイルを作成致しました。)<br><br>
...
　出勤時間・退勤時間・休憩開始時間・休憩終了時間のそれぞれの時間が、その項目の後に設定、前に設定する必要があることに関して不適切な設定にならないように、withValidator(追加検証)としてApplicationAndAttendantRequest.phpに実装致しました。<br>
