...
　修正申請等を入れやすいように平日7％の確率でユーザーごとに出勤なし,休憩一般的な1日3回,合計55分〜60分(残業時4回,合計65分〜70分),<br>
...
　(一般ユーザー用勤怠詳細ページで修正申請後,承認待ち：＊承認待ちのため修正はできません。(表示専用)<br>
　/承認済み：＊この日は一度承認されたので修正できません。(表示専用)<br>
