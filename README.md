...
- Viewファイル<br>
　今回からviewファイル関係はケバブケースで開発するようにしました。模擬案件1つ目はコード品質,Ui要件,マイリストでの検索機能の未実装,新規登録・ログイン時をformrequestでの実装,ER図の不備等ありましたが,今後良い仕事をしながら向上できるように今回からPrettierを利用して開発効率と可読性,技術を向上させていきたいと思っています。
- バリデーション関係<br>
