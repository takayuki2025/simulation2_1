                            ...
                            <tr>
                                ...
                                <td class="time-inputs">
                                    ...
                                    <div class="input-block">
                                        <input type="text" name="clock_in_time" {{-- old()を優先し、データがあればフォーマットして表示 --}} value="{{ old('clock_in_time', $primaryData && $primaryData->clock_in_time ? \Carbon\Carbon::parse($primaryData->clock_in_time)->format('H:i') : '') }}" class="@error('clock_in_time') is-invalid @enderror" />
                                        @error('clock_in_time')
                                    ...
                                    {{-- 2. 退勤時刻入力ブロック --}}
                                    <div class="input-block">
                                        <input type="text" name="clock_out_time" {{-- old()を優先し、データがあればフォーマットして表示 --}} value="{{ old('clock_out_time', $primaryData && $primaryData->clock_out_time ? \Carbon\Carbon::parse($primaryData->clock_out_time)->format('H:i') : '') }}" class="@error('clock_out_time') is-invalid @enderror" />
